    ...
    public function login($json)
    {
        ...
        try {
            if (isset($json['username']) && isset($json['password'])) {
                ...
                $sql = 'SELECT `pid`, `firstname`, `lastname`, `email`, `password`
                        FROM `passengers`
    ...
    public function signup($json)
    {
        ...
        try {
            if (
                ...
                $checkSql = 'SELECT * FROM `passengers` WHERE `email` = :email';
                ...
                $sql = 'INSERT INTO `passengers` (`firstname`, `lastname`, `email`, `password`) 
